...
func (jc *JobController) createNewPod(job interface{}, rt string, index int, spec *apiv1.ReplicaSpec, masterRole bool,
	...
	// 2. if no SchedulerName is set for pods and gang-scheduler-name is default-scheduler, we will not set SchedulerName.
	// Otherwise, we set the SchedulerName to gang-scheduler-name.
