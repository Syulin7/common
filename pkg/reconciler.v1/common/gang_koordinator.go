...
func (r *KoordinatorReconciler) OverrideForGangSchedulingInterface(ui ReconcilerUtilInterface) {
	if ui != nil {
...
func (r *KoordinatorReconciler) GangSchedulingEnabled() bool {
	return r.BaseGangReconciler.GangSchedulingEnabled()
}

// GetPodGroupName returns the name of PodGroup for this job
func (r *KoordinatorReconciler) GetPodGroupName(job client.Object) string {
	return r.BaseGangReconciler.GetPodGroupName(job)
}

// GetPodGroupForJob returns the PodGroup associated with this job
func (r *KoordinatorReconciler) GetPodGroupForJob(ctx context.Context, job client.Object) (client.Object, error) {
...
func (r *KoordinatorReconciler) DeletePodGroup(ctx context.Context, job client.Object) error {
...
func (r *KoordinatorReconciler) ReconcilePodGroup(
	ctx context.Context,
	job client.Object,
...
func (r *KoordinatorReconciler) calcPGMinResources(
	minMember int32,
	replicas map[commonv1.ReplicaType]*commonv1.ReplicaSpec,
) *corev1.ResourceList {
